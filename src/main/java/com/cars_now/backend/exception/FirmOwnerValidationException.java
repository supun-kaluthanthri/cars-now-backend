...
public class FirmOwnerValidationException extends Exception{
    private final ValidationConst validationValue;

    public FirmOwnerValidationException(final ValidationConst validationConst, final String message) {
        super(message);
